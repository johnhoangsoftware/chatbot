...
class TechnicalDocumentParser:
    """
    Advanced PDF parser optimized for technical documents.
    ...
    def parse(self, file_path: str) -> ParsedDocument:
        """Parse a technical document and extract structured content."""
...
class DocumentParser(TechnicalDocumentParser):
    """Backward compatible parser class."""
    pass
