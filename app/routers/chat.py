...
async def chat_stream(request: ChatRequest):
    """
    Chat with streaming response - returns Server-Sent Events.
    Text is sent as it's generated by the model.
    """
    ...
    logger.info(f"Streaming chat: session={request.session_id}, message={request.message[:50]}...")
